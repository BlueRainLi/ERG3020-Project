...
\begin{figure}[htb]
    \centering 
    \includegraphics[width=\columnwidth]{arch3.png} 
    \caption[Prompting Users to Post facts]{Prompting Users to Post Facts} 
    \end{figure}
